...
/*************************************************************************************************/
  ...
  /****************************    Motor minthrottle    *******************************/
    ...
    #define MINTHROTTLE 1180 // Changed from 1100 to 1180 for RCTIMER 30A escs (*) (**)

  /****************************    Motor maxthrottle    *******************************/
    /* this is the maximum value for the ESCs at full power, this value can be increased up to 2000 */
    #define MAXTHROTTLE 2000 // CHanged to 2000 from 1900
  ...
  /**********************************  I2C speed for old WMP config (useless config for other sensors)  *************/
    ...
    #define I2C_SPEED 400000L   //400kHz fast mode, it works only with some WMP clones enabled this
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /*********************    Lowpass filter for some gyros    ****************************/
      ...
      //#define GYRO_LPF_42HZ
      #define GYR0_LPF_20HZ		// This is the default setting
  ...
  /**************************************************************************************/
	...
	/* (EEPROM) Get your magnetic declination from here : http://magnetic-declination.com/
	 ...
	 Also note, that maqgnetic declination changes with time, so recheck your value every 3-6 months */
	  #define MAG_DECLINATION  13.48f        // For San Ramon
